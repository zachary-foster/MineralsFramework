...
namespace Minerals2
{
    ...
    public static class Minerals_World_NaturalRockTypesIn_Patch
    {
        ...
        public static void MakeRocksAccordingToBiome(int tile, ref World __instance, ref IEnumerable<ThingDef> __result)
        {
            ...
            else
            {
                ...
                int num = Rand.RangeInclusive(Minerals2Main.Settings.terrainCountRangeSetting.min, Minerals2Main.Settings.terrainCountRangeSetting.max);
                if (num > list.Count)
                {
                    num = list.Count;
                }
    ...
    static class HarmonyPatches
    {
        ...
        {
            Harmony harmony = new Harmony("com.zacharyfoster.minerals2");
